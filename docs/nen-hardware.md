...
Đây là nghề **cho ra sản phẩm cầm được trên tay**. Vừa là điểm hấp dẫn, vừa là lý do phải review kỹ: board sai có thể phải sửa thủ công hoặc đặt lại, tốn tiền và thời gian.
...
Nếu quen sửa nhanh rồi chạy lại, bạn sẽ cần tập thêm thói quen kiểm tra theo checklist trước khi cấp nguồn hoặc đặt sản xuất. Đây là kỹ năng có thể rèn, không phải tố chất phải có sẵn.
...
|--------|-----------------|
| **Số học, đại số và đơn vị đo** | Đổi đơn vị, biến đổi công thức, đọc đồ thị; học thêm giải tích khi bài toán thật sự cần |
...
Trước khi vẽ PCB đầu tiên, hãy dựng một mạch nhỏ trên breadboard, đo điện áp và kiểm tra tín hiệu. Bước này rẻ hơn nhiều so với phát hiện sai sau khi board đã sản xuất.
...
| **Layout PCB** | Bắt đầu với board 2 lớp: mặt phẳng đất, đường nguồn và tụ decoupling; chỉ lên nhiều lớp khi có lý do rõ ràng |
...
Dùng nguồn thấp áp 3,3 V hoặc 5 V do CLB cấp, dựng một mạch LED có điện trở hạn dòng trên breadboard. Tính dòng dự kiến, nhờ người phụ trách kiểm tra cách mắc trước khi cấp nguồn, rồi đo điện áp và so sánh với tính toán.

Không dùng điện lưới và chưa cần vẽ PCB. Mục tiêu là tập quy trình: tính → lắp khi chưa cấp nguồn → kiểm tra → cấp nguồn → đo → giải thích chênh lệch.
...
>
> Chưa cần đặt sản xuất. Cần đúng, giải thích được từng lựa chọn và được một người có kinh nghiệm review trước khi đặt board thật.

Bảng cuối là phần được chấm kỹ nhất. Một layout đẹp mà các con số lấy từ suy đoán vẫn có thể hoạt động sai, không ổn định hoặc làm hỏng linh kiện.
...
Tìm 5–10 tin tuyển **Hardware Engineer**, **PCB Design** hoặc **Electronics Engineer** gần đây từ nhiều nguồn. Chú ý các yêu cầu lặp lại về công cụ EDA, nguồn, EMC, thiết bị đo và quy trình đưa board vào sản xuất; số lớp board chỉ là một phần, không phải thước đo trình độ duy nhất. [Nhóm tuyển dụng lập trình nhúng](https://web.facebook.com/groups/775890384111054) là một nguồn tham khảo.
